...
import { atualizarVariacaoAcoesETFs } from '@/lib/financeiro/roboVariacao'

export const dynamic = 'force-dynamic'
export const maxDuration = 60

// Robô da variação % das Ações e ETFs da La Jolla (busca no Yahoo Finance).
// Disparado por:
...
export async function GET(request: NextRequest) {
  ...
  try {
    const resultado = await atualizarVariacaoAcoesETFs()
